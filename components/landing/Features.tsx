        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
          {features.map((feature, idx) => (
            ...
            >
              ...
              <a
                href="#"
                className="mt-10 inline-block w-full text-center px-5 py-2 sm:px-6 sm:py-3 md:px-8 md:py-4 xl:px-10 xl:py-5 rounded-2xl bg-gradient-to-r from-gradient-from via-gradient-via to-gradient-to font-semibold text-white text-sm sm:text-base md:text-lg xl:text-xl shadow-lg transition hover:opacity-90"
              >
